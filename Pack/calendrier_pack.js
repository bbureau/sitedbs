class Calendar
            {   
                constructor(domTarget,packs,location)
                {   
                ...
                {   
                    ...
                    for(let i=1; i<=monthLength; i++)
                    {
                        ...
                        //on parcourt les différents articles du pack
                        for(var k=0; k< this.packs.length; k++)
                        {   
                            var ID = this.packs[k];
                            
                            var quantite = this.packs[k+1];
                            
                            var dispoID = this.packs[k+2];
                            ...
                            {  
                                var date1 = this.location[j+1], date1t = date1.split('-');
                                ...
                                var date2 = this.location[j+2], date2t = date2.split('-');
                                ...
                                if(timestamp<=date_loca2 && date_loca1<=timestamp && this.location[j] == ID)
                                { 
